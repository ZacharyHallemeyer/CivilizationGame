...
public class ClientSS
{
    ...
    public TCP tcp;
    public UDP udp;
    public PlayerSS player;
    public string tribe;

    public static Dictionary<int, ClientSS> allClients = new Dictionary<int, ClientSS>();

    public ClientSS(int _clientId)
    {
        id = _clientId;
        tcp = new TCP(id);
        udp = new UDP(id);
    ...
    public void SendPlayerIntoGame()
    {
        ...
        ServerSend.SendTileInfo(id, WorldGeneratorSS.instance.tiles);
        // Send neutral cities to new player
        ServerSend.SendNeutralCityInfo(id, WorldGeneratorSS.instance.neutralCities);
    }
